...
describe("canStartThread()", () => {
  ...
  // Бан проверяется раньше статуса: причина отказа должна называть аккаунт, а не
  // объявление. Случай с active здесь не гипотетический — статус мог разойтись с
  // баном, если объявление подняли вручную.
