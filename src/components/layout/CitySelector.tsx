...
export function CitySelector({
  ...
  return (
    ...
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger className="inline-flex h-9 min-w-0 items-center gap-1 rounded-sm px-3 text-sm text-foreground transition-colors hover:bg-foreground/5">
