...
export type ConnectionStatus =
  ...
  | "offline"
  /** Терминальный отказ: сессии нет или чужой Origin. Не переподключаемся. */
  | "unauthorized"
  /** Терминальный отказ по бану. Отдельно от unauthorized, потому что сессия у
   *  забаненного как раз живая, и текст про её конец был бы неправдой. */
  | "banned"
